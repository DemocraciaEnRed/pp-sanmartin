<template>
  <section>
    ...
    <p><span class="is-600">Estos campos no serán visibles publicamente, son a efecto de la convocatoria a proyectos</span>.</p>
    </div>
    <div class="columns">
      <div class="column">
        <div class="field">
    ...
    <div class="field">
      <h1 class="title is-4">
        <i class="fas fa-caret-right"></i>&nbsp;Organización
      </h1>
      <div class="control">
        <b-checkbox v-model="project.withOrganization" size="is-medium">
          El proyecto se lleva a cabo con una organizacion (ONG, institucion civil, etc.)
        </b-checkbox>
      </div>
    </div>
    <div class="notification is-primary" v-if="project.withOrganization">
      <h1 class="title is-3 is-marginless"><i class="fas fa-users"></i>&nbsp;Datos de la organización</h1>
      <p>Si el proyecto lo lleva a cabo una organización, complete los datos que corresponden de la institución civil.</p>
     </div>
    <section v-if="project.withOrganization">
      <div class="field">
    ...
    <div class="field">
      <h1 class="title is-4" :class="{'has-text-danger': errors.has('project.type')}">
        <i class="fas fa-caret-right"></i>&nbsp;Elegí el tipo de proyecto
      </h1>
      <h1 class="subtitle is-6">
        <span class="has-text-link">* Requerido.</span> ¿Es un proyecto ciudadano/comunitario o una iniciativa del municipio?
      </h1>
      <div class="control">
        <div class="select is-large is-fullwidth">
          ...
          >
            <option :value="null" disabled>- Selecciona el tipo de proyecto -</option>
            <option value="ciudadano">Ciudadano/Comunitario</option>
            <option value="institucional">Iniciativa del municipio</option>
          </select>
        </div>
    ...
    <div class="field">
      <h1 class="title is-4" :class="{'has-text-danger': errors.has('project.district_id')}">
        <i class="fas fa-caret-right"></i>&nbsp;Elija el barrio
      </h1>
      <h1 class="subtitle is-6">
        <span class="has-text-link">* Requerido.</span> ¿En donde tiene impacto el proyecto?
      </h1>
      <div class="control">
        <div class="select is-large is-fullwidth" :class="{'is-loading': districtsLoading}">
          <select
            ...
            placeholder="Seleccione el barrrio"
          >
            <option :value="null" disabled>- Selecciona la localidad -</option>
            <option
    ...
    <div class="field">
      ...
      <h1 class="subtitle is-6">
          <span class="has-text-link">* Requerido.</span> ¿Cual es la población identificada que se verá beneficiada con tu proyecto?. Tenes un máximo de 1500 caracteres
      </h1>
      <div class="control">
        <b-input
    ...
    <!-- <div class="field">
      ...
      <h1 class="subtitle is-6">
          <span class="has-text-link">* Requerido.</span> ¿Cuales van a ser los aportes comunitarios que ofrecerá tu proyecto?. Tenes un máximo de 1500 caracteres
      </h1>
      <div class="control">
        <b-input
    ...
    <!-- <div class="field">
      <div class="notification is-primary">
     <h1 class="title is-3 is-marginless"><i class="fas fa-file-invoice-dollar"></i>&nbsp;El presupuesto de tu proyecto</h1>
      <p>Detalle como se compone el presupuesto del proyecto.</p>
    </div>
     <b-message type="is-warning">
        <b><i class="fas fa-exclamation-triangle"></i>&nbsp;IMPORTANTE: El limite a presupuestar en proyectos institucionales es $ 400.140 y en proyectos comunitarios $ 600.210</b>
      </b-message>
      <h1 class="title is-4" :class="{'has-text-danger': errors.has('project.budget')}">
          <i class="fas fa-caret-right"></i>&nbsp; Items del presupuesto
      </h1>
      <h1 class="subtitle is-6">
          <span class="has-text-link">* Requerido.</span> Defina cada item del presupuesto que presenta el proyecto. Escribí descripción del mismo, y el monto en pesos (sin centavos)
      </h1>
...
<script>
export default {
  props: ["project", "editing", "editable"],
  data() {
    return {
