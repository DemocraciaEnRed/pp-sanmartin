  ...
  <div>
    ...
    <div v-else>
      ...
      <div class="notification is-danger is-size-7" v-show="response.replied && !response.ok">
        ...
        Error enviando el email a "{{email}}". ¿Ya se encuentra registrado con este email? Verifique su conexión de internet e intente más tarde. Si el problema persiste, contactesé con la Unidad de Presupuesto Participativo (mesadeayudainformatica@sanmartin.gov.ar )
      </div>
    </div>
