<template>
  <section>
    ...
    <div v-if="showAddCitizen">
      <add-citizen :url="urlAddCitizen" :allow-restart="false" :url-participacion="urlParticipacion" :districts="districts"></add-citizen>
    </div>
...
export default {
  props: ["url", "urlAddCitizen","urlParticipacion","votable","districts"],
  components: {
    Avatar,
    AddCitizen
  },
