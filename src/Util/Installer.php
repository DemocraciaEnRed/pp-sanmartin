...
class Installer
{
    ...
    public function populate()
    {
        ...
        $this->db->table('categories')->insert([
            ['name' => 'Ciudadanos y comunitarios', 'description' => 'Se pueden votar hasta dos (2) proyectos ciudadanos y comunitarios'],
            ['name' => 'Iniciativas del municipio', 'description' => 'Se pueden votar hasta un (1) proyecto de la municipalidad']
        ]);
        ...
        $this->db->table('options')->insert([
            ...
            [
                'key' => 'rain-message',
                'value' => 'En caso de llvia, nos podés encontrar en el parador turístico de San Martín, 3 de Febrero entre San Carlos y Sg. Cabral',
                'type' => 'string',
                'group' => 'varios',
                'autoload' => true,
            ],
        ...
        $this->db->table('subjects')->insert([
            ...
            [
                'id' => 2,
                'display_name' => 'Pepe Gallegos',
                'img_type' => 0,
                'img_hash' => md5('usuario1@gmail.com'),
                'points' => 0,
                'type' => 'User',
                'trace' => 'PepeGallegos',
                'citizen_id' => null,
