  ...
  <b-table :data="projects">
    <template slot-scope="props">
      ...
      <b-table-column field="name" label="proyecto">
        ...
        <p class="is-size-7" v-if="props.row.type == 'ciudadano'">Presentado por&nbsp;<b-tooltip position="is-left" multilined label="El responsable se encuentra registrado en la plataforma"  v-if="props.row.author_id"><i class="fas fa-user fa-fw has-text-link"></i></b-tooltip><b>{{props.row.author_names}} {{props.row.author_surnames}}</b></p>
        <div v-else>
       ...
       <span class="tag" :class="{'is-ciudadano': props.row.type == 'ciudadano', 'is-institucional': props.row.type == 'institucional'}">{{capitalizeFirstLetter(props.row.type)}}</span>
      ...
      <b-table-column label="Acciones">
        ...
        <p class="is-size-7"><a :href="`/admin/proyectos/${props.row.id}/editar`" class="has-text-link"><i class="fas fa-edit fa-lg fa-fw"></i>&nbsp;Editar proyecto</a></p>
