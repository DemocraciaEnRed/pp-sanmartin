<template>
  <section>
    <form-project ref="formProject" :editing="true" :budget="budget" :project.sync="project" :editable="editable" :district="district"></form-project>
    <hr>
    ...
    <div class="message is-success" v-show="response.replied && response.ok">
      <div class="message-body">
        <i class="fas fa-check fa-fw"></i>&nbsp;<b>¡Bien!</b> ¡Tu proyecto ha sido editada correctamente!
      </div>
    </div>
...
export default {
  props: ["formUrl","budget", "existingProject", "editable", "district"],
  components: {
    FormProject
  },
  data() {
  ...
  beforeMount: function(){
    ...
    this.project.withOrganization = this.existingProject.organization_name ? true : false;
  },
  methods: {
    submit: function() {
      this.isLoading = true
