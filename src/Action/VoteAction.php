...
class VoteAction
{
    ...
    public function showVoting($request, $response, $params)
    {
        ...
        if(!is_null($citizen->voted_at)){
            throw new UnauthorizedException('Ya ha participado del Presupuesto Participativo de San Martín');
        }
    ...
    public function runVoting($request, $response, $params)
    {
        ...
        $citizen = $this->helper->getCitizenFromSubject($subject);
        if(!is_null($citizen->voted_at)){
            throw new UnauthorizedException('No puede enviar tu voto, ya has participado del Presupuesto Participativo de San Martín');
        }
