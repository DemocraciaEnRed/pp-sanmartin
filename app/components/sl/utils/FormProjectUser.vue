<template>
  <section>
    ...
    <div class="field">
     ...
     <p>Complete los datos que corresponde a la organización / institución civil.</p>
     </div>
    ...
    <div class="field">
      <h1 class="title is-4" :class="{'has-text-danger': errors.has('project.district_id')}">
        <i class="fas fa-caret-right"></i>&nbsp;Localidad del proyecto
      </h1>
      <h1 class="subtitle is-6">
        <span class="has-text-link">* No editable.</span> Donde el proyecto tiene lugar (Recuerde, no puede proponer proyectos que no sean de su localidad)
      </h1>
      <div class="control">
    ...
    <!-- <div class="field">
     ...
     <h1 class="title is-3 is-marginless"><i class="fas fa-file-invoice-dollar"></i>&nbsp;El presupuesto de tu proyecto</h1>
      <p>Detallá como se compone el presupuesto de tu proyecto.</p>
    </div>
     <b-message type="is-warning">
      ...
      <h1 class="subtitle is-6">
          <span class="has-text-link">* Requerido.</span> Definí cada item del presupuesto que presenta tu proyecto. Definí una descripción del mismo, y el monto en pesos (sin centavos)
      </h1>
...
<script>
export default {
  props: ["project", "editing", "user", "citizen", "editable","district"],
  data() {
    return {
  ...
  mounted: function() {
    ...
    this.project.district_id = this.district.id
  },
  methods: {
    // addItem: function() {
    //   this.$validator
