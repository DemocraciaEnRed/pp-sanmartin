<template>
  <section>
      <h1 class="title is-3 is-marginless">
        <i class="fas fa-clipboard-check"></i>&nbsp;Factibilidad de el proyecto
      </h1>
    ...
    <h1 class="subtitle is-6">
          <span class="has-text-link">* Requerido.</span> El proyecto terminará siendo factible o no factible. Defina su estado en base a su sentencia.
      </h1>
