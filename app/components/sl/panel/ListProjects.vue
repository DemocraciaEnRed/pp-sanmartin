  ...
  <b-table :data="projects">
    <template slot-scope="props">
      ...
      <b-table-column label="Acciones" width="150">
        <p class="is-size-7" v-if="editAvailable"><a :href="`/panel/proyectos/${props.row.id}/editar`" class="has-text-link"><i class="fas fa-edit fa-lg fa-fw"></i>&nbsp;Editar proyecto</a></p>
    ...
    <template slot="empty">
      <section class="section">
        <div class="content has-text-grey has-text-centered">
            ...
            <p>No cargaste ningun proyecto</p>
          </div>
      </section>
    </template>
  </b-table>
